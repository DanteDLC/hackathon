...
export default function TopBar({
  ...
  return (
    <div className={`w-full backdrop-blur-xl border-b shadow-lg px-6 py-5 flex justify-between items-center transition-colors duration-300 ${
      darkMode 
      ...
      <div>
        ...
        <p className={`text-sm mt-1 font-medium transition-colors duration-300 ${
          ...
          Temp: {aiConfig.temperature} • Tokens: {aiConfig.maxTokens.toLocaleString()} • Top-P: {aiConfig.topP} • Top-K: {aiConfig.topK}
        </p>
      </div>
      <div className="flex items-center space-x-3">
        <button
